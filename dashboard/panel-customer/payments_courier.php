...
$payment_mode = "Live"; // "Live" or "Test"
	...
	$sql_1 = "SELECT shipping_subtotal,	tracking,comments FROM courier WHERE shipping_subtotal = '$shipping_subtotal' AND correo ='$user_or_payer_email_address'";
...
$vpb_notification_url = 'http://'.str_replace(basename($_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]), '', $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]).'notifications-paypal-courier.php';
