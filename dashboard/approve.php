...
<script type="text/javascript">
	...
	function suma(){														
		...
		resultado = parseFloat(Math.round(sum1.value) + parseFloat(sum2.value * sum5.value/100)  + parseFloat(sum3.value) +  parseFloat(sum4.value * sum6.value - sum6.value)).toFixed(0);
