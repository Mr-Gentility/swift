								...
								<div class="row">
								 <div class="col-md-2 margin-bottom-3" >
								  ...
								  <div class="col-md-1 margin-bottom-3">
									...
									<input type="number" class="form-control" parsley-trigger="change" required name="rate" placeholder="<?php echo $_SESSION['ge_curr']; ?>" > 
														
								  </div>
								  <div class="col-md-1 margin-bottom-3">
									<label class="control-label" ><strong><?php echo $Longitud; ?></strong></label>
									<input type="number" class="form-control" parsley-trigger="change" required name="rate1" placeholder="0 cm" > 
														
								  </div>
						 
								  <div class="col-md-1 margin-bottom-3">
									<label class="control-label" ><strong><?php echo $Ancho; ?></strong></label>
									<input type="number" class="form-control" parsley-trigger="change" required name="rate2" placeholder="0 cm" > 
														
								  </div>
								  <div class="col-md-1 margin-bottom-3">
									<label class="control-label" ><strong><?php echo $Altura; ?></strong></label>
									<input type="number" class="form-control" parsley-trigger="change" required name="rate3" placeholder="0 cm" > 
