				  ...
				  <h4><i class="icon-plane"></i>&nbsp;&nbsp;<?php echo $LISTADEENVÍOPRINCIPAL ?></a></h4>
					...
					<table ui-jq="dataTable" class="table table-striped b-t b-b">
						...
						<tbody>
						  <tr>
								<?php
									$result3 = mysql_query("SELECT c.cid, c.tracking, c.cons_no, c.book_mode, c.locker, c.ship_name, c.rev_name, c.shipping_subtotal, c.payment, c.paymode, c.pick_date, c.user, s.color, c.status
							  ...
							  <td><strong><?php echo $_SESSION['ge_curr']; ?><?php echo formato($row['shipping_subtotal']); ?></strong></td>
