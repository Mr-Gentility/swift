...
// *************************************************************************
	...
	$user = $_POST['user'];
	 ...
	 $sql = "UPDATE courier_online
	   SET cons_no='$cons_no', ship_name='$ship_name',shippercc='$shippercc',s_phone='$s_phone',s_add='$s_add',email='$email',countries='$countries',iso='$iso',ciudad='$ciudad',
	   ...
	   deliverydate='$deliverydate',status='$status',deliver='$deliver',user='$user'
	   WHERE cid = '$cid'";				   
