...
// *************************************************************************
	...
	$sql_3 = "INSERT INTO accounting (tracking,ship_name,locker,book_mode,shipping_subtotal,office,user, book_date)
				VALUES('$pre-$cons_no','$ship_name','$locker','$book_mode','$shipping_subtotal','$office','$user',curdate() )";	
			//echo $sql;
	dbQuery($sql_3);
