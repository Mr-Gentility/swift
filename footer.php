...
<section class="footer">
    ...
    <div class="footer-block col-md-3 col-sm-3">
        ...
        <ul class="hidden-xs">
            ...
            <li><a href="index.html#track-shipment" tabindex="-1">Track A Parcel</a></li>
            <li><a rel="nofollow" href="index.html" tabindex="-1">Get A Quote</a></li>
        </ul>
    </div>
...
<div class="fw footer-dark">
    <section class="footer footer-baseline">
        <p class="footer-text mob-me">&copy; Copyright 2022 Swift Trust Global</p>
